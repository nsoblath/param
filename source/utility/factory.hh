...
#ifndef PARAM_FACTORY_HH_
#define PARAM_FACTORY_HH_
...
namespace param
{
    ...
    void factory< XBaseType, XArgs... >::register_class( const std::string& a_class_name, const base_registrar< XBaseType, XArgs... >* a_registrar )
    {
        ...
        if (it != fMap->end())
        {
            std::cerr << "Already have factory registered for <" << a_class_name << ">." << std::endl;
            return;
        }
        fMap->insert(std::pair< std::string, const base_registrar< XBaseType, XArgs... >* >(a_class_name, a_registrar));
        COUT_DEBUG( "Registered a factory for class " << a_class_name << " at " << (*fMap)[ a_class_name ] << ", factory #" << fMap->size()-1 << " for " << this );
    }
    ...
    {
        COUT_DEBUG( "Removing factory for class " << a_class_name << " from " << this );
    ...
    XBaseType* factory< XBaseType, void >::create( const std::string& a_class_name )
    {
        ...
        if( it == fMap->end() )
        {
            COUT_DEBUG( "Did not find factory for <" << a_class_name << ">." );
            return NULL;
        }
    ...
    void factory< XBaseType, void >::register_class( const std::string& a_class_name, const base_registrar< XBaseType >* a_registrar )
    {
        ...
        COUT_DEBUG( "Registered a factory for class " << a_class_name << ", factory #" << fMap->size()-1 << " for " << this );
    }
